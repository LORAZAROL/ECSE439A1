...
/**
 * This is the item provider adapter for a {@link ca.mcgill.emf.examples.hal.Operand} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperandItemProvider extends PreconditionItemProvider {
	/**
	...
	protected void addSentencePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Operand_sentence_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Operand_sentence_feature",
								"_UI_Operand_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HalPackage.Literals.OPERAND__PRECONDITION);
		}
	...
	public String getText(Object object) {
		String label = ((Operand) object).getSentence();
		return label == null || label.length() == 0 ? getString("_UI_Operand_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(HalPackage.Literals.OPERAND__PRECONDITION, HalFactory.eINSTANCE.createOperand()));

		newChildDescriptors.add(createChildParameter(HalPackage.Literals.OPERAND__PRECONDITION,
				HalFactory.eINSTANCE.createOperation()));
	}
