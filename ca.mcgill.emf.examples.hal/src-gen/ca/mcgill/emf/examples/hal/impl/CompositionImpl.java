 ...
 * </p>
 * <ul>
 *   <li>{@link ca.mcgill.emf.examples.hal.impl.CompositionImpl#getPrecondition <em>Precondition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompositionImpl extends PreconditionImpl implements Composition {
	/**
	...
	protected EClass eStaticClass() {
		return HalPackage.Literals.COMPOSITION;
	}
	...
	public EList<Precondition> getPrecondition() {
		if (precondition == null) {
			precondition = new EObjectContainmentEList<Precondition>(Precondition.class, this,
					HalPackage.COMPOSITION__PRECONDITION);
		}
		return precondition;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case HalPackage.COMPOSITION__PRECONDITION:
